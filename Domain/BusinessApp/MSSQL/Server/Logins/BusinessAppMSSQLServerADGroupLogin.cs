...
public class BusinessAppMSSQLServerADGroupLogin : IBusinessAppOwnedResource, IHasBusinessAppActiveDirectoryGroup
{
    ...
    public virtual BusinessAppActiveDirectoryGroup BusinessAppActiveDirectoryGroup { get; set; } = null!;
