...
builder.Services.AddA2AWellKnownAgent((provider, builder) =>
{
    builder
        ...
        .WithUrl(new("/requestintake-a2a", UriKind.Relative))
        .SupportsStreaming()
        .WithSkill(skill => skill
            .WithId("datchecktool")
            .WithName("datchecktool")
            .WithDescription("check the day and see what it is saying."));
});
...
app.MapA2AHttpEndpoint("/requestintake-a2a");
