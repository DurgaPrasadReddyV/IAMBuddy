...
namespace AD_Provisioning_Demo
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            .AddGoogleAIGeminiChatCompletion(modelId: "gemini-2.5-flash", apiKey: "AIzaSyAdQZBNMVoB2RJKL3PCz3bjXUoG4_WD6eY");
